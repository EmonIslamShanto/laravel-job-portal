    ...
    <form action="{{ route('candidate.profile.account-info.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="box-button mt-15">
                <button class="btn btn-primary font-md font-bold">Save All Changes</button>
            </div>
        </div>
    </form>
    ...
    <div>
        <form action="" class="mt-4">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        <label class="font-sm color-text-mutted mb-10">User Email*</label>
                        <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text"
                            name="address" value="{{ $candidate?->address }}">
                        <x-input-error :messages="$errors->get('address')" class="mt-2" />
                    </div>
                ...
                <div class="box-button mt-15">
                    <button class="btn btn-primary font-md font-bold">Save Changes</button>
                </div>
            </div>
        </form>
    </div>
