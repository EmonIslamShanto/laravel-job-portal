                                    ...
                                    <div class="card-grid-2-image-left d-flex">
                                        ...
                                        <div class="card-profile pt-10">
                                            ...
                                            @if ($candidate?->status === 'available')
                                                <p class="font-sm color-text-paragraph-2"><b>I am avaialable</b></p>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="employers-info align-items-center justify-content-center mt-15">
                                            <div class="row">
                                                <div class="col-6"><span class="d-flex align-items-center"><i
                                                            ...
                                                            class="font-sm color-text-mutted">{{ $candidate?->countryName?->name }}</span></span></div>
                                                <div class="col-6"><span
                                                        class="d-flex justify-content-end align-items-center"><i
                                                            class="fi-rr-user mr-5"></i><span
                                                            class="font-sm"><a href="{{ route('candidates.show', $candidate?->slug) }}" class="text-primary">View Resume</a></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
