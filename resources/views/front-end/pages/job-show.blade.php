                        ...
                        <div class="row">
                            <div class="col-md-6 d-flex">
                                ...
                                <div class="sidebar-text-info ml-10">
                                    <span class="text-description industry-icon mb-10">Category</span>
                                        ...
                                        @if ($job->salary_mode === 'range')
                                            <div class="col-lg-7 col-7">
                                                <span class="card-text-price">{{ $job->min_salary }} -
                                                    {{ $job->max_salary }}</span>
                                                <span class="text-muted">BDT /{{ $job->salaryType->name }}</span>
                                            </div>
                                        @else
                                            <div class="col-lg-7 col-7">
                        ...
                        <div class="row mt-25">
                            ...
                            <div class="col-md-6 d-flex mt-sm-15">
                                ...
                                <div class="sidebar-text-info ml-10">
                                    ...
                                    <strong class="small-heading">{{ formatLocation($job->company->countryName?->name, $job->company->stateName?->name, $job->company->cityName?->name, $job->address) }}</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                    <div class="sidebar-border">
                        <div class="sidebar-heading">
                            <div class="avatar-sidebar">
                                ...
                                <div class="sidebar-info"><span class="sidebar-company">{{ $job->company->name }}</span><span
                                        class="card-location">{{ formatLocation($job->company->countryName?->name, $job->company->stateName?->name) }}</span>
                                        @if ($openJobs > 0)
                        ...
                        <div class="sidebar-list-job">
                            ...
                            <ul class="ul-disc">
                                <li>{{ formatLocation($job->company->countryName?->name, $job->company->stateName?->name, $job->company->cityName?->name, $job->address) }}</li>
