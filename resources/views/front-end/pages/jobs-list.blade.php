                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-2-image-left">
                                                    ...
                                                    <div class="right-info"><a class="name-job"
                                                            ...
                                                            class="location-small">{{ formatLocation($job->company->countryName?->name, $job->company->stateName?->name, $job->company->cityName?->name, $job->address) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 text-start text-md-end pr-60 col-md-6 col-sm-12">
                                                <div class="pl-15 mb-15 mt-30">
                                                    ...
                                                    @endif
                                                    @if ($job->highlight)
                                                        <a class="btn btn-grey-small mr-5 highlight" href="javascript:;">Highlighted</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                            <h4><a href="{{ route('findJobs.show', $job->slug) }}">{{ $job->title }}</a></h4>
                                            <div class="mt-5">
                                            ...
                                            <div class="pl-15 mb-15 mt-30">
                                                @foreach ($job->skills as $jobSkill)
                                                    <a class="btn job-skill btn-grey-small mr-5"
                                                ...
                                                <div class="row">
                                                    @if ($job->salary_mode === 'range')
                                                        <div class="col-lg-7 col-7">
                                                            <span class="card-text-price">{{ $job->min_salary }} - {{ $job->max_salary }}</span>
