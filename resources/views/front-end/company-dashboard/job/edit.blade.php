        ...
        <div class="breacrumb-cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <h2 class="mb-20">Update Job Post</h2>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group d-flex">
                                                            <input @checked($job?->salary_mode === 'range')  style="height: 18px; width: 18px" type="radio"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group d-flex">
                                                            <input @checked($job?->salary_mode === 'custom')  style="height: 18px; width: 18px" type="radio"
                                                                class=" {{ hasError($errors, 'salary_mode') }}"
