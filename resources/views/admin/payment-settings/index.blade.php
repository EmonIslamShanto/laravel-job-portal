                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                          <h4>All payment gateway settings</h4>
                        </div>
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-10">
                              <div class="tab-content no-padding" id="myTab2Content">
                                @include('admin.payment-settings.payment-section.paypal-section');

                                @include('admin.payment-settings.payment-section.stripe-section');
