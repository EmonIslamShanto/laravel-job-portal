...
@section('contents')
<section class="section-box mt-75 mb-100">
    <div class="breacrumb-cover">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-12">
            <h2 class="mb-20">Registration</h2>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mx-auto">
          <div class="login-register-cover">
            <div class="text-center">
              ...
              <p class="font-sm text-muted mb-30">Don't have you an account? Create one.</p>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-12">
                  <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="input-1" type="text" required="" name="name" value="{{ old('name') }}"
