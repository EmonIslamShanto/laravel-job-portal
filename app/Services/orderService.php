    ...
    static function setUserPlan()
    {
        ...
        UserPlan::updateOrCreate(
            ...
            [
                ...
                'job_limit' => $userPlan?->job_limit ? $userPlan->job_limit + Session::get('selected_plan')['job_limit'] : Session::get('selected_plan')['job_limit'],
                'featured_job_limit' => $userPlan?->featured_job_limit ? $userPlan->featured_job_limit + Session::get('selected_plan')['featured_job_limit'] : Session::get('selected_plan')['featured_job_limit'],
                'highlight_job_limit' => $userPlan?->highlight_job_limit ? $userPlan->highlight_job_limit + Session::get('selected_plan')['highlight_job_limit'] : Session::get('selected_plan')['highlight_job_limit'],
